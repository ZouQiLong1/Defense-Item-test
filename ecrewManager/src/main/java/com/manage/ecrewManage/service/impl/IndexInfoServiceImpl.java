...
public class IndexInfoServiceImpl implements IndexInfoService {
    ...
    public List<User> selectUser() {
        List<User> users = indexInfoDao.selectUser();
        return users;
    }
    /**
     * 分页查询用户信息
     ...
     */
    @Override
    public PageBean<User> selectUserByPage(String _currentPage, String _pageSize, Map<String, String[]> parameterMap) {
        //创建一个pageBean，保存信息
        ...
        //查询数据库中的user的总数据
        int totalCount = indexInfoDao.selectTotalCount(parameterMap);
        ...
        List<User> list = indexInfoDao.selectUserByPage(start,pageSize,parameterMap);
