...
import com.manage.ecrewManage.service.impl.CommodityInfoServiceImpl;
...
@WebServlet("/goodsInfoByPageServlet")
public class goodsInfoByPageServlet extends HttpServlet {
    //service是公用的，因此直接放在最外面
    private CommodityInfoService commodityInfoService = new CommodityInfoServiceImpl();
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<Commodity> pageBean = commodityInfoService.selectUserByPage(currentPage,pageSize,condition);
