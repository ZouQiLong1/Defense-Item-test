...
@WebServlet("/indexInfoByPageServlet")
public class IndexInfoByPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<User> pageBean = indexInfoService.selectUserByPage(currentPage,pageSize,condition);
