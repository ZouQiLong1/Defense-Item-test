...
<div class="container-fluid position-relative" style="width:800px ;">
  <div style="background-color:rgba(245,171,171,0.91); margin-top: 50px; padding: 20px 50px; border-radius: 15px">
    ...
    <form action="${pageContext.request.contextPath}/addCommodityServlet">
      <div class="form-group" style="margin-top: 20px;">
        <label for="title" style="color: #000; margin-bottom: 10px;">商品名</label>
        <input type="text" class="form-control" id="title" name="title" placeholder="请输入商品名">
      </div>
      <div class="form-group" style="margin-top: 20px;">
      ...
      <input style="width: 250px; margin-left: 200px; margin-top: 30px; height: 50px; background-color:#ff002f; color: #fff;border: none;border-radius: 5px" type="submit" value="注册">
    </form>
  </div>
  </div>
  <!-- Content End -->
