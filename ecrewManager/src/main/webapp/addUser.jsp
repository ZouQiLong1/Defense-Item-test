...
<div class="container-fluid position-relative" style="width:800px ;">
  <div style="background-color:#c9e7fa; margin-top: 50px; padding: 20px 50px; border-radius: 15px">
    ...
    <form method="post" action="${pageContext.request.contextPath}/addUserServlet">
      <div style="color: red; text-align:center; font-size: 18px">${err_msg}</div>
      <div class="form-group" style="margin-top: 20px;">
        <label for="name" style="color: #000; margin-bottom: 10px;">姓名</label>
        <input type="text" name="name" class="form-control" id="name" placeholder="请输入新用户姓名">
      </div>
      <div class="form-group" style="margin-top: 20px;">
        <label for="username" style="color: #000; margin-bottom: 10px;">账号</label>
        <input type="text" name="username" class="form-control" id="username" placeholder="请输入新用户账号">
      </div>
      <div class="form-group" style="margin-top: 20px;">
        <label for="password" style="color: #000; margin-bottom: 10px;">密码</label>
        <input type="password" name="password" class="form-control" id="password" placeholder="请输入新用户密码">
      </div>
      <div class="form-group" style="margin-top: 20px;">
      ...
      <div class="form-group" style="margin-top: 20px;">
        ...
        <input type="email" name="email" class="form-control" id="email" placeholder="请输入新用户邮箱">
      </div>
      <input style="width: 250px; margin-left: 200px; margin-top: 30px; height: 50px; background-color:#009CFF; color: #fff;border: none;border-radius: 5px" type="submit" value="注册">
    </form>
  </div>
  </div>
  <!-- Content End -->
